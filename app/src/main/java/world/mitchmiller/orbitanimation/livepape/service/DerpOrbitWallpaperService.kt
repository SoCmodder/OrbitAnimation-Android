package world.mitchmiller.orbitanimation.livepape.service
...
import world.mitchmiller.orbitanimation.livepape.MyPoint

//https://www.vogella.com/tutorials/AndroidLiveWallpaper/article.html
class DerpOrbitWallpaperService : WallpaperService() {

    override fun onCreateEngine(): Engine {
        return OrbitWallpaperEngine()
    }

    private inner class OrbitWallpaperEngine : WallpaperService.Engine() {
        private var handler: Handler = Handler()
        private var drawRunner: Runnable = Runnable { draw() }
        ...
        init {
            val prefs = PreferenceManager
                .getDefaultSharedPreferences(this@DerpOrbitWallpaperService)
            maxNumber = Integer
